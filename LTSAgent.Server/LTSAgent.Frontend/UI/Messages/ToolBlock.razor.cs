...
public partial class ToolBlock : IDisposable
{
    ...
    [Parameter]
    public ChatUIMessage.Tool Message { get; set; } = default!;
    ...
    /// <summary> 현재 도구의 메타데이터. 각 렌더러 컴포넌트가 자신의 메타를 제공 </summary>
    ...
    /// <summary> 컴포넌트 초기화 시 진행 중이면 타이머를 시작 </summary>
