...
public sealed class ModelSettings(ModelRegistry Registry)
{
    ...
    /// <summary> SON 직렬화 옵션  </summary>
    private static readonly JsonSerializerOptions JsonOptions = new() { WriteIndented = true };
    
    /// <summary> 현재 선택된 모델 정의  </summary>
    private IModel CurrentModel = new Models.Opus48();
    
    /// <summary> 확장된 사고 활성화 여부 백킹 필드  </summary>
    private bool ThinkingEnabled = true;
    
    /// <summary> 사고 깊이 백킹 필드  </summary>
    private Effort CurrentEffort = Effort.High;
    
    /// <summary> API 모델 ID  </summary>
    ...
    /// <summary> 확장된 사고(Extended Thinking) 활성화 여부  </summary>
    ...
    /// <summary> Claude의 사고 깊이. thinking과 독립적으로 동작  </summary>
    ...
    /// <summary> 현재 설정을 파일에 저장. 디렉토리가 없으면 생성 </summary>
    private void Save()
    {
    ...
    /// <summary> 설정 파일에서 로드. ModelRegistry가 초기화된 후 호출 </summary>
    public void Load()
    {
